...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="carowner.php"><i class="fa fa-circle-o"></i> Car Owner</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 align="center">
        <i class="fa fa-cab"></i> Car Owner Encoding
        <small></small>
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-cab"></i> Car Owner Data Table</h3><button type="button" class="btn btn-success btn-sm" style="margin-left: 2%" data-toggle="modal" data-target="#add">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Add Car Owner</h4>
              </div>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  placeholder="Enter Car Owner Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Contact</label>
                  <input type="text" class="form-control"  placeholder="Enter Car Owner Contact">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Address</label>
                  <input type="text" class="form-control"  placeholder="Enter Car Owner Address">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Facebook Account</label>
                  <input type="text" class="form-control"  placeholder="Enter Car Owner Facebook Account">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Username</label>
                  <input type="text" class="form-control"  placeholder="Enter Car Owner Username">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Password</label>
                  <input type="password" class="form-control" placeholder="Enter Car Owner Password">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Status</label>
                  <input type="text" class="form-control" placeholder="Enter Car Owner Status">
                </div>
                <div class="form-group">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background-color: #c5c5c5;">
                  ...
                  <th style="width: 11%"><i class="fa fa-user-secret"></i>Owner</th>
                ...
                <tr>
                  ...
                  <td>********</td>
                  <td>User 1</td>
                  <td align="center"><a class="btn btn-warning btn-xs">Data</a></td>
                  <td align="center"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit"><i class="fa fa-pencil"></i></button> <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></td>
                </tr>
                </tbody>
                <tfoot>
           ...
           <form role="form">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Update Car Owner</h4>
              </div>
              <div class="modal-body">
